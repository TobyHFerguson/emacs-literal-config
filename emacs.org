...
*** DAYPLAN
    I use Reinig Konig's method of a dayplan.

    To make it easy to copy items from my agenda to the plan I use his
    function:
...
*** Capture
    ...
    - External Links :: File in ~inbox.org~ under a single top
                        heading "Inbox"
    - Dayplan :: a dayplan, in =dayplan.org=, in date tree mode, from
                 the =dayplan.txt= template file
    #+name: org-config
    #+BEGIN_SRC emacs-lisp
...
** Integration with Gcal
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq org-gcal-client-id "871683950797-qnqit9lit9vtbb3inhrkutb0aattou87.apps.googleusercontent.com"
           ...
           org-gcal-file-alist (list (cons "toby.h.ferguson@gmail.com"   (expand-file-name "calendar.org" org-directory))))
   #+END_SRC
