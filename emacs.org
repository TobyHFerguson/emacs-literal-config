...
* Global navigation
  ...
  I want to quickly get to my gtd file
...
*** Agenda
    I want to keep the number of files to the three critical
    ones. Note that ~someday.org~ is omitted - I never want those
    items on the agenda.
    #+BEGIN_SRC emacs-lisp
      (setq org-agenda-files '("~/gtd/inbox.org"
                           ...
                           "~/gtd/tickler.org"))
    #+END_SRC
    I don't want to see scheduled items until the date they're needed.

    I also don't want to see scheduled items which are DONE in the
    agenda either. 
    #+name: org-config
    #+BEGIN_SRC emacs-lisp
    ...
    I want to quickly jump to work and emacs tasks
    #+NAME: org-config
    #+BEGIN_SRC emacs-lisp
    ...
    #+END_SRC
*** Capture
    I want to capture todo items, tickler items, journal entries etc. 
    #+NAME: org-config
    #+BEGIN_SRC emacs-lisp
