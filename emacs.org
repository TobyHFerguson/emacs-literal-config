...
** Getting things done
   ...
   #+BEGIN_SRC emacs-lisp
     (setq org-todo-keywords
           '((sequence "TODO(t)" "WAITING(w@)" "SOMEDAY(s)" "APPT(a)"  "DEFERRED(e)" "|" "CANCELLED(c@)" "DONE(d!)")))
...
*** Agenda
    I want my agenda to only be built from my inbox, my projects and
    my tickler.
    #+name: org-config
    #+BEGIN_SRC emacs-lisp
   ...
   #+BEGIN_SRC emacs-lisp
     (setq org-agenda-custom-commands
           '(
             ("i" "inbox" tags ".*" ((org-agenda-files '("inbox.org"))))
             ("w" "At work"
              ((agenda)
...
** Archiving
   ...
   #+NAME: org-config
   #+BEGIN_SRC emacs-lisp
     (setq org-archive-location (concat (file-name-as-directory org-directory) "Archive"))
   #+END_SRC
